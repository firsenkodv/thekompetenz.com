<header>
    <div class="header_background">
        <video autoplay muted loop playsinline id="background-video">
            <source src="{{ Storage::url('video/header_background.mp4') }}" type="video/mp4">
        ...
        <div class="block">
            <x-swiper.slider :slides="config2('moonshine.home.slider')" />
        </div>
        <div class="block">
            <div class="_line"></div>
        </div>
        <div class="block">
            <div class="our_mission">
                <div class="our_mission__left">Our mission</div>
                <div class="our_mission__right">
                    <p>{{  (config2('moonshine.home.our_mission')) }}</p>
                </div>
            </div>
        </div>
    </div>

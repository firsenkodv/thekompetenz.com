...
class IndividualPage extends Page
{
    ...
    public function setting()
    {
        ...
        if (Storage::disk('config')->exists('moonshine/individual.php')) {
            $result = include(storage_path('app/public/config/moonshine/individual.php'));
        } else {
            $result = null;
        }
    ...
    {
        return $this->title ?: 'Individual Category';
    }
    ...
    protected function components(): iterable
    {
        ...
        return [
            FormBuilder::make('/moonshine/individual', FormMethod::POST)
                ->fields([

                    Tabs::make([

                        Tab::make(__('Individual'), [

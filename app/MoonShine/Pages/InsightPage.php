...
class InsightPage extends Page
{
    ...
    public function setting()
    {
        ...
        if (Storage::disk('config')->exists('moonshine/insight.php')) {
            $result = include(storage_path('app/public/config/moonshine/insight.php'));
        } else {
            $result = null;
        }
    ...
    {
        return $this->title ?: 'Insights Category';
    }
    ...
    protected function components(): iterable
    {
        ...
        return [
            FormBuilder::make('/moonshine/insight', FormMethod::POST)
                ->fields([

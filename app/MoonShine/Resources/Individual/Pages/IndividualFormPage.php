...
namespace App\MoonShine\Resources\Individual\Pages;
...
/**
 * @extends FormPage<IndividualResource>
 */
class IndividualFormPage extends FormPage
{
    /**
                    ...
                    Tab::make(__('Setting'), [
                        Grid::make([
                            Column::make([
                                ...
                                Box::make([
                                    Text::make('Back', 'back')->unescape()->default('Back to services'),
                                    Text::make('Slogan', 'slogan')->unescape()->default('Service for individuals'),

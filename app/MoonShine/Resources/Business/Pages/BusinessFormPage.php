...
namespace App\MoonShine\Resources\Business\Pages;
...
/**
 * @extends FormPage<BusinessResource>
 */
class BusinessFormPage extends FormPage
{
                ...
                Tabs::make([
                        ...
                        Tab::make(__('Setting'), [
                            ...
                            Column::make([
                                ...
                                Box::make([
                                    Text::make('Back', 'back')->default('Back to services')->unescape(),
                                    Text::make('Slogan', 'slogan')->default('Service for business')->unescape(),

...
final class InsightController extends MoonShineController
{
    use Upload;
    ...
    public function insight(Request $request): Response
    {
        ...
        $data = $request->all();
        /**  Сохраняем файл **/
        $destinationPath = 'images/insight';
        if(isset($data['temp_img']))
        {
            $array = (config2_array('moonshine.insight'));
        ...
        Storage::disk('config')->put("moonshine/insight.php", "<?php\n\n" . 'return ' . var_export($data, true) . ";\n");

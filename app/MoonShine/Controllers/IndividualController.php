...
final class IndividualController extends MoonShineController
{
    use Upload;


    public function individual(Request $request): Response
    {
        ...
        /**  Сохраняем файл **/
        $destinationPath = 'images/individual';

        if(isset($data['temp_img']))
        {
            $array = (config2_array('moonshine.individual'));
        ...
        Storage::disk('config')->put("moonshine/individual.php", "<?php\n\n" . 'return ' . var_export($data, true) . ";\n");
